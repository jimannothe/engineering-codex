...
- Overwrite it as work changes.
- Move durable decisions into the roadmap, project notes, or weekly review.
- If a detail stops being current, remove it instead of preserving stale context.
